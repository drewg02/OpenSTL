...
def show_video_line_stacked(trues, preds_dict, ncols, vmax=1.0, vmin=0, cmap='gray', norm=None, cbar=False,
...
if __name__ == "__main__":
    ...
    show_video_line_stacked(trues, preds_dict, ncols=10, vmax=0.6, cbar=False, format='png', cmap='coolwarm',
