...
from openstl.simulation.visualization import save_visualization
...
def main():
    ...
    save_visualization(args.datafolder, simulation_class,
                       args.start_frame_index, args.end_frame_index, args.output_single_images, args.rows, args.space,
                       args.save_path)
